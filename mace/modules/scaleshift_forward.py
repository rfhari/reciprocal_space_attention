    def forward(
        ...
        for i, (interaction, product, readout) in enumerate(
            ...
            node_feats_lr = self.efa[i](
                 data,
                 node_feats_x,                  # (N, F)
                 self.kweights,                 # (Kvectors, ) learnable weights for k-frequencies
            )
        ...
        print('alpha is', self.alpha, 'and silu(alpha) is', self.silu(self.alpha), 'kweights is', self.kweights)
        ...
        # print("modified from hariarr_layerwise_efa")
